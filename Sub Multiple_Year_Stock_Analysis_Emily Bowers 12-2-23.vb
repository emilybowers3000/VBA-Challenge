        ...
        For i = 2 To lastRow
            ...
            If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Or i = lastRow Then
                ...
                If Yearly_Change >= 0 Then
                    ws.Cells(Summary_Table_Row, 12).Interior.Color = RGB(0, 255, 0)
                Else
                    ws.Cells(Summary_Table_Row, 12).Interior.Color = RGB(255, 0, 0)
                End If
                
                If Percent_Change >= 0 Then
                    ws.Cells(Summary_Table_Row, 13).Interior.Color = RGB(0, 255, 0)
                Else
                    ws.Cells(Summary_Table_Row, 13).Interior.Color = RGB(255, 0, 0)
                End If
                    
               'script to get the 3rd table showing greatest % increase, % decrease, greatest total volume
